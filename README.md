...
Executes extract_load.py to fetch up to 3 days of high-frequency data into the Bronze layer.
Runs dbt run to process the data through Silver and Gold layers.
Executes dbt test to validate the final output before the BI layer consumes it.
